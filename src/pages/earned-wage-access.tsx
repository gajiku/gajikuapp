    ...
    <DefaultLayout>
      ...
      <section className="pb-16 lg:px-32 md:px-16 px-4">
        <div className="grid md:grid-cols-2">
          <div>
            <h2 className="text-primary text-[2.5rem]/[1.2] mb-4 font-extrabold">
              Keuntungan Earned Wage Access (EWA) Gajiku:
            </h2>
            <div className="flex flex-col gap-y-8 mt-8">
              <div className="flex gap-x-4">
                <div className="rounded-full p-2 bg-gray-200 h-fit w-fit">
                  <HiOutlineCheck size={24} className="font-light" />
                </div>
                <div className="text-base font-[350]">
              ...
              <div className="flex gap-x-4">
                ...
                <div className="text-base font-[350]">
                  Memungkinkan karyawan untuk mengakses uang mereka tanpa harus meminjam dari pihak ketiga atau
              ...
              <div className="flex gap-x-4">
                ...
                <div className="text-base font-[350]">
                  Membantu karyawan mengatasi masalah keuangan sehari-hari seperti membayar tagihan, membeli bahan
                  makanan, atau membayar sewa.
                </div>
              </div>
              <div className="flex gap-x-4">
                <div className="rounded-full p-2 bg-gray-200 h-fit w-fit">
        ...
        <div className="text-base font-[350] mt-8">
