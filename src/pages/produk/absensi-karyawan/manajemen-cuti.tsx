    ...
    >
      <div className="grid lg:grid-cols-2">
        <div className="px-6 antialiased">
          <h1 className="text-primary text-[3rem]/[1.2] mb-4 font-extrabold">Aplikasi Cuti Karyawan Berbasis Web, IOS, Android </h1>
          <p className="text-[1.25rem]/[1.75] font-normal mb-8">Pengajuan, atur kuota dan persetujuan cuti jadi lebih mudah</p>
      ...
      <div className="grid md:grid-cols-2 gap-y-16 gap-x-8">
        <div className="flex flex-col gap-y-4 justify-center">
          ...
          <p className="text-lg font-[350]">
            Pengajuan cuti di perusahaan dapat di atur dalam berbagai level, jumlah yang harus menyetujui. Proses mudah dapat dilakukan melalui aplikasi karyawan
          </p>
        ...
        <div className="flex flex-col gap-y-4 justify-center">
          ...
          <p className="text-lg font-[350]">
            Berbagai jenis cuti bisa dibuat dengan pengaturan yang fleksibel seperti pengaturan pro-rata untuk cuti tahunan, cuti yang bersifat hanya sekali dan sebagainya
          </p>
          <div className="w-fit mt-4">
            <Button tag="a" color="primary" className="text-white" size="sm" href="/contact-us">Hubungi Kami <HiArrowRight /></Button>
          </div>
        ...
        <div className="flex flex-col gap-y-4 justify-center">
          ...
          <p className="text-lg font-[350]">
            Atur sisa cuti karyawan apakah akan hilang di tahun selanjutnya ataupun membawa sisa cuti dari tahun sebelumnya, semua bisa atur
          </p>
          <div className="w-fit mt-4">
            <Button tag="a" color="primary" className="text-white" size="sm" href="/contact-us">Hubungi Kami <HiArrowRight /></Button>
          </div>
