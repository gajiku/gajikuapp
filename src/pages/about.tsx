  ...
  return <DefaultLayout>
      ...
      <div className="max-w-4xl mx-auto mt-16 pb-16 grid md:grid-cols-2 gap-x-4">
        <div className="antialiased ml-[50px] content-center md:pb-0 pb-16">
          <div className="relative">
            <span className="absolute text-white opacity-[0.08] text-[72px] left-[-50px] top-[-65px] font-bold z-0">#1</span>
            <h4 className="relative text-white text-3xl mb-4 font-extrabold z-1">2020</h4>
          </div>
          <p className="text-white text-lg font-normal">Gajiku hadir sebagai pioneer fasilitator Early Wage Access di Indonesia, dan membangun kerjasama dengan berbagai enterprise.</p>
        </div>
        ...
        <div className="antialiased ml-[50px] content-center md:pb-0 pb-16">
          <div className="relative">
            <span className="absolute text-white opacity-[0.08] text-[72px] left-[-50px] top-[-65px] font-bold z-0">#2</span>
            <h4 className="relative text-white text-3xl mb-4 font-extrabold z-1">2021</h4>
          </div>
          <p className="text-white text-lg font-normal">Di back up oleh Sampoerna, Gajiku memperluas solusi yang dibangun ke ranah solusi digital dalam sektor tenaga kerja melalui HRIS.</p>
        </div>

        <div className="antialiased ml-[50px] content-center md:pb-0 pb-16">
          <div className="relative">
            <span className="absolute text-white opacity-[0.08] text-[72px] left-[-50px] top-[-65px] font-bold z-0">#3</span>
            <h4 className="relative text-white text-3xl mb-4 font-extrabold z-1">2022</h4>
          </div>
          <p className="text-white text-lg font-normal">Mencapai tahap Seed A dengan rounding dari berbagai VC termasuk Sampoerna & AC Ventures sembari terus mengembangkan teknologi HR terkini.</p>
        </div>
        <div className="content-center lg:block hidden">
        ...
        <div className="antialiased ml-[50px] content-center md:pb-0 pb-16">
          <div className="relative">
            <span className="absolute text-white opacity-[0.08] text-[72px] left-[-50px] top-[-65px] font-bold z-0">#4</span>
            <h4 className="relative text-white text-3xl mb-4 font-extrabold z-1">Saat Ini</h4>
          </div>
          <p className="text-white text-lg font-normal">Gajiku terus berkembang untuk memenuhi kebutuhan dan memberikan solusi terbaik khususnya di bidang HR Technology</p>
        </div>
      </div>
    </section>
    ...
    <section className="py-16 px-4" id="media">
      <div className="max-w-6xl bg-gray-100 border rounded-lg shadow-xl mx-auto lg:py-16 py-8 px-8">
        <h2 className="text-primary lg:px-32 md:px-16 px-4 text-center text-[2.5rem]/[1.2] mb-16 font-extrabold">Tim Gajiku</h2>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="flex flex-col gap-y-1 justify-center items-center self-start">
            ...
            <p>Co-Founder/ CEO</p>
            <a href="https://www.linkedin.com/in/sherman-tanuwidjaja" className="text-xl py-2 " target="_blank"  rel="nofollow noopener">
                <FaLinkedin />
            </a>
            
            <p className="mb-4 text-center">Pitch and sold ~$300K project for Temasek. Led team recruitment and backend architecture as Tech lead.</p>
            <p className="mb-4 text-center">Raised Pre-seed round with Sequioa, RTP and Febe Ventures as Co-Founder of Vara</p>
            <p className="mb-4 text-center">Founder 20-person dev shop, Ocurise Consultancy, and generated 400k in revenue in the first year</p>
          </div>
          <div className="flex flex-col gap-y-1 justify-center items-center self-start">
            <Avatar src={AboutHerry.src} shape="circle" size={120} className="mb-4" />
            <h3 className="text-primary text-lg">Herry Gunawan </h3>
            <p>Co-Founder/ CEO</p>
            <a href="https://www.linkedin.com/in/herryg91" className="text-xl py-2 " target="_blank"  rel="nofollow noopener">
                <FaLinkedin />
            </a>
            
            <p className="mb-4 text-center">Tech lead at Tokopedia, Build search, personalization and recommendation team from scratch. Bult and structured entire architecture and development.</p>
            <p className="mb-4 text-center">Climbed Ruang Guru ladder from Engineering manager all the way to head of Engineering. Leading team of 40 engineers.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="py-16 px-4" id="media">
      <div className="max-w-6xl bg-gray-100 border rounded-lg shadow-xl mx-auto lg:py-16 py-8 px-8">
        <h2 className="text-primary lg:px-32 md:px-16 px-4 text-center text-[2.5rem]/[1.2] mb-16 font-extrabold">Founding Member</h2>
        <div className="grid md:grid-cols-4 grid-cols-2 gap-8 items-center">
          <div className="flex flex-col gap-y-1 justify-center items-center self-start">
            ...
            <p>Head of Product</p>
            <a href="https://www.linkedin.com/in/brian-ridwan" className="text-xl py-2 " target="_blank"  rel="nofollow noopener">
                <FaLinkedin />
            </a>
          </div>
          <div className="flex flex-col gap-y-1 justify-center items-center self-start">
            ...
            <a href="https://www.linkedin.com/in/cantika-dewi-498b681b3" className="text-xl py-2 " target="_blank"  rel="nofollow noopener">
                <FaLinkedin />
            </a>
          </div>
          <div className="flex flex-col gap-y-1 justify-center items-center self-start">
            ...
            <a href="https://www.linkedin.com/in/effene-herry" className="text-xl py-2 " target="_blank"  rel="nofollow noopener">
                <FaLinkedin />
            </a>
          </div>
          <div className="flex flex-col gap-y-1 justify-center items-center self-start">
            ...
            <a href="https://www.linkedin.com/in/tyas-hayuwuri-067665bb" className="text-xl py-2 " target="_blank"  rel="nofollow noopener">
                <FaLinkedin />
            </a>
          </div>
        </div>
